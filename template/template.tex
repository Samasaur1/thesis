...
\IfFileExists{./acknowledgements.tex}{\chapter*{Acknowledgements}\input{acknowledgements.tex}}{}
\IfFileExists{./preface.tex}{\chapter*{Preface}\input{preface.tex}}{}
...
\begin{table}[h]
    ...
    \end{tabular}
\end{table}
\todo{I need some way to distinguish vertically between consecutive definitions}
$endif$

\IfFileExists{./abstract.tex}{\chapter*{Abstract}\input{abstract.tex}}{}
\IfFileExists{./dedication.tex}{\chapter*{Dedication}\input{dedication.tex}}{}
...
$endif$
$biblio.tex()$
\todo{should this have header and/or footer? if header, header needs to change}
