...
Bencode was pretty clearly designed to be easy to parse in a single pass, in which it is successful.

i did this in @gauck_implementing_2022.

very easy to get dictionaries

### Parsing into typed objects

we want to parse into typed objects instead of dicts.
we don't want to manually do the conversion from dicts to objects.
swift has support for parsing into typed objects.
