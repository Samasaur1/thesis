...
%% The fun begins:
\begin{document}
    \fancyfoot[LE]{\it Built off of \href{https://github.com/Samasaur1/thesis/commit/\commitRev}{commit {\fontfamily{cmtt}\selectfont\commitShortRev}}}
...
% To remove it, comment it out or delete it.
    ...
    {
        % Don't color links in the table of contents
