\begin{tikzpicture}
    ...
    \node[rectangle,draw=black,anchor=north,minimum size=1.5em] (us-piece3) at ($(us.south)$) {\phantom{3}};
    \node[rectangle,draw=black,anchor=east,minimum size=1.5em] (us-piece2) at ($(us-piece3.west)$) {\phantom{2}};
    \node[rectangle,draw=black,anchor=east,minimum size=1.5em] (us-piece1) at ($(us-piece2.west)$) {\phantom{3}};
    \node[rectangle,draw=black,anchor=west,minimum size=1.5em] (us-piece4) at ($(us-piece3.east)$) {\phantom{3}};
    \node[rectangle,draw=black,anchor=west,minimum size=1.5em] (us-piece5) at ($(us-piece4.east)$) {\phantom{3}};

    \draw ($(us.east)$) -- ($(peera.west)$) node [midway,sloped,above=2pt,rectangle,draw=black,fill=orange!70,minimum size=1.5em] (movingpiece) {2};
