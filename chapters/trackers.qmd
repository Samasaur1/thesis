...
::: {#fig-trackers layout-ncol=3}

![We connect to the tracker](trackers-figure-1.tex){#fig-trackers-connect-to-tracker width=90%}

![We receive peer addresses](trackers-figure-2.tex){#fig-trackers-tracker-response width=90%}

![We can now connect to the peers](trackers-figure-3.tex){#fig-trackers-found-peers width=90%}
...
URLs are allowed to consist of the following characters at any point in the URL @berners-lee_uniform_2005:
