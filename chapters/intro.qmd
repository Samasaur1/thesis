...
1. He begins by acquiring the metainfo file Alice generated (`sams-thesis.pdf.torrent`).
1. He opens it in his BitTorrent client.
1. Bob's client parses the metainfo file and connects to the *tracker* listed in the file.
...
1. Bob's client then connects to some of these peers (in this case, only to Alice) and begins the *peer wire protocol* with each of them (see @sec-peer-wire-protocol).
