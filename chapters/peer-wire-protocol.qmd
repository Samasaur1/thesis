...
#### Outgoing connections to peers listed in the responses from the tracker
...
#### Incoming connections on the socket the client listens on {#sec-peer-wire-protocol-listening-socket}
