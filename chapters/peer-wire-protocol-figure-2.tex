\begin{tikzpicture}
    ...
    \node[rectangle,draw=black,anchor=east,minimum size=1.5em] (us-piece1) at ($(us-piece2.west)$) {\phantom{1}};
    \node[rectangle,draw=black,anchor=west,minimum size=1.5em] (us-piece4) at ($(us-piece3.east)$) {\phantom{4}};
    \node[rectangle,draw=black,fill=cyan!50,anchor=west,minimum size=1.5em] (us-piece5) at ($(us-piece4.east)$) {5};

    \draw ($(us.east)$) -- ($(peera.west)$) node [midway,sloped,above=2pt,rectangle,draw=black,fill=green!50,minimum size=1.5em] (movingpiece) {4};
    ...
    \draw ($(us.east)$) -- ($(peerb.west)$) node [pos=0.7,sloped,above=2pt,rectangle,draw=black,fill=cyan!50,minimum size=1.5em] (movingpieceb) {5};
